...
nome_empresa = "imoveis tedesc ltda"
cnpj_empresa = "01.366.733/001-64"
...
for indice, info_funcionario  in tabela_funcionarios.iterrows():
  ...
  salario_funcionario = info_funcionario.salario
    ...
    texto_recibo = f"Pelo presente, eu {nome_funcionario}, inscrito no CPF sob nº {cpf_funcionario}, declaro que RECEBI na data de hoje, o valor de R${salario_funcionario}, \
  por meio de depósito bancário, {nome_empresa}, \
  inscrito no CNPJ sob nº{cnpj_empresa}, referente ao mês anterior ao da data da assinatura, já incluindo todas as horas devidas e benefícios."
